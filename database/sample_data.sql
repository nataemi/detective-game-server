...
INSERT INTO ITEM(name, description, image, examResult, type_of_item) VALUES("dlugopis kumpla", "Prosty dlugopis z czarnym atramentem", null, "dlugopis jest identyczny do twojego. Nawet tak samo nadgryziony. Podejrzane.", "I");
INSERT INTO ITEM(name, description, image, examResult, type_of_item) VALUES("dlugopisy nauczyciela", "Sterta dlugopisow lezaca na biurku nauczyciela. Jest ich na tyle duzo ze ciezko powiedziec czy znajduje się tam twój.", null, "Raczej zaden z nich nie wyglada na twoj.", "I");

INSERT INTO ITEM(name, description, image, examResult, type_of_item) VALUES("Halina Abacka", "Nauczycielka w szkole podstawowej nr 46. Mężatka. Kasztanowe włosy i niebieskie oczy. Uczniowie raczej nie darzą jej sympatią. Bardzo wymagająca.", null, null, "P");
